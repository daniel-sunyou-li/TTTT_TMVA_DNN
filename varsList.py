...
# generalized values
nrun = {
  "TTJetsHad": 129092906.0,
  "TTJetsSemiLep": 109124472.0,
  "TTJets2L2nu": 68448328.0,
  "TTJets2L2nuUEdn": 5431150.0,
  "TTJets2L2nuUEup": 5455598.0,
  "TTJets2L2nuHDAMPdn": 5248352.0,
  "TTJets2L2nuHDAMPup": 5389169.0,
  "TTJetsSemiLep": 109124472.0,
  "TTJetsSemiLepNjet9": 8648145.0 
}
...
all2017 = {
  ...
  "TTJets2L2nuTT1b": ( "TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8_tt1b_hadd.root", nrun["TTJets2L2nu"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuTT2b": ( "TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8_tt2b_hadd.root", nrun["TTJets2L2nu"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuTTbb": ( "TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8_ttbb_hadd.root", nrun["TTJets2L2nu"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuTTcc": ( "TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8_ttcc_hadd.root", nrun["TTJets2L2nu"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuTTjj": ( "TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8_ttjj_hadd.root", nrun["TTJets2L2nu"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  
  "TTJets2L2nuUEdnTT1b": ( "TTTo2L2Nu_TuneCP5down_PSweights_13TeV-powheg-pythia8_tt1b_hadd.root", nrun["TTJets2L2nuUEdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEdnTT2b": ( "TTTo2L2Nu_TuneCP5down_PSweights_13TeV-powheg-pythia8_tt2b_hadd.root", nrun["TTJets2L2nuUEdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEdnTTbb": ( "TTTo2L2Nu_TuneCP5down_PSweights_13TeV-powheg-pythia8_ttbb_hadd.root", nrun["TTJets2L2nuUEdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEdnTTcc": ( "TTTo2L2Nu_TuneCP5down_PSweights_13TeV-powheg-pythia8_ttcc_hadd.root", nrun["TTJets2L2nuUEdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEdnTTjj": ( "TTTo2L2Nu_TuneCP5down_PSweights_13TeV-powheg-pythia8_ttjj_hadd.root", nrun["TTJets2L2nuUEdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEupTT1b": ( "TTTo2L2Nu_TuneCP5up_PSweights_13TeV-powheg-pythia8_tt1b_hadd.root", nrun["TTJets2L2nuUEup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEupTT2b": ( "TTTo2L2Nu_TuneCP5up_PSweights_13TeV-powheg-pythia8_tt2b_hadd.root", nrun["TTJets2L2nuUEup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEupTTbb": ( "TTTo2L2Nu_TuneCP5up_PSweights_13TeV-powheg-pythia8_ttbb_hadd.root", nrun["TTJets2L2nuUEup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEupTTcc": ( "TTTo2L2Nu_TuneCP5up_PSweights_13TeV-powheg-pythia8_ttcc_hadd.root", nrun["TTJets2L2nuUEup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuUEupTTjj": ( "TTTo2L2Nu_TuneCP5up_PSweights_13TeV-powheg-pythia8_ttjj_hadd.root", nrun["TTJets2L2nuUEup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPdnTT1b": ( "TTTo2L2Nu_hdampDOWN_TuneCP5_PSweights_13TeV-powheg-pythia8_tt1b_hadd.root", nrun["TTJets2L2nuHDAMPdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPonTT2b": ( "TTTo2L2Nu_hdampDOWN_TuneCP5_PSweights_13TeV-powheg-pythia8_tt2b_hadd.root", nrun["TTJets2L2nuHDAMPdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPonTTbb": ( "TTTo2L2Nu_hdampDOWN_TuneCP5_PSweights_13TeV-powheg-pythia8_ttbb_hadd.root", nrun["TTJets2L2nuHDAMPdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPonTTcc": ( "TTTo2L2Nu_hdampDOWN_TuneCP5_PSweights_13TeV-powheg-pythia8_ttcc_hadd.root", nrun["TTJets2L2nuHDAMPdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPonTTjj": ( "TTTo2L2Nu_hdampDOWN_TuneCP5_PSweights_13TeV-powheg-pythia8_ttjj_hadd.root", nrun["TTJets2L2nuHDAMPdn"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPupTT1b": ( "TTTo2L2Nu_hdampUP_TuneCP5_PSweights_13TeV-powheg-pythia8_tt1b_hadd.root", nrun["TTJets2L2nuHDAMPup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPupTT2b": ( "TTTo2L2Nu_hdampUP_TuneCP5_PSweights_13TeV-powheg-pythia8_tt2b_hadd.root", nrun["TTJets2L2nuHDAMPup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPupTTbb": ( "TTTo2L2Nu_hdampUP_TuneCP5_PSweights_13TeV-powheg-pythia8_ttbb_hadd.root", nrun["TTJets2L2nuHDAMPup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPupTTcc": ( "TTTo2L2Nu_hdampUP_TuneCP5_PSweights_13TeV-powheg-pythia8_ttcc_hadd.root", nrun["TTJets2L2nuHDAMPup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  "TTJets2L2nuHDAMPupTTjj": ( "TTTo2L2Nu_hdampUP_TuneCP5_PSweights_13TeV-powheg-pythia8_ttjj_hadd.root", nrun["TTJets2L2nuHDAMPup"], xsec["TTJets"] * BR["TTJets2L2nu"] ),
  
  "TTJetsHadTT1b": ( "TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_tt1b_hadd.root", nrun["TTJetsHad"], xsec["TTJets"] * BR["TTJetsHad"] ),
  "TTJetsHadTT2b": ( "TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_tt2b_hadd.root", nrun["TTJetsHad"], xsec["TTJets"] * BR["TTJetsHad"] ),
  "TTJetsHadTTbb": ( "TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_ttbb_hadd.root", nrun["TTJetsHad"], xsec["TTJets"] * BR["TTJetsHad"] ),
  "TTJetsHadTTcc": ( "TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_ttcc_hadd.root", nrun["TTJetsHad"], xsec["TTJets"] * BR["TTJetsHad"] ),
  "TTJetsHadTTjj": ( "TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_ttjj_hadd.root", nrun["TTJetsHad"], xsec["TTJets"] * BR["TTJetsHad"] ),
  "TTJetsSemiLepNjet9binTT1b": ( "TTToSemiLepton_HT500Njet9_TuneCP5_PSweights_13TeV-powheg-pythia8_tt1b_hadd.root", nrun["TTJetsSemiLepNjet9"], xsec["TTJets"] * BR["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ) ),
  "TTJetsSemiLepNjet9binTT2b": ( "TTToSemiLepton_HT500Njet9_TuneCP5_PSweights_13TeV-powheg-pythia8_tt2b_hadd.root", nrun["TTJetsSemiLepNjet9"], xsec["TTJets"] * BR["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ) ),
  "TTJetsSemiLepNjet9binTTbb": ( "TTToSemiLepton_HT500Njet9_TuneCP5_PSweights_13TeV-powheg-pythia8_ttbb_hadd.root", nrun["TTJetsSemiLepNjet9"], xsec["TTJets"] * BR["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ) ),
  "TTJetsSemiLepNjet9binTTcc": ( "TTToSemiLepton_HT500Njet9_TuneCP5_PSweights_13TeV-powheg-pythia8_ttcc_hadd.root", nrun["TTJetsSemiLepNjet9"], xsec["TTJets"] * BR["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ) ),
  "TTJetsSemiLepNjet9binTTjj": ( "TTToSemiLepton_HT500Njet9_TuneCP5_PSweights_13TeV-powheg-pythia8_ttjj_hadd.root", nrun["TTJetsSemiLepNjet9"], xsec["TTJets"] * BR["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ) ),
  "TTJetsSemiLepNjet0TT1b": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_tt1b_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TT2b": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_tt2b_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TTbb": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_ttbb_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TTcc": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_ttcc_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TTjj1": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_ttjj_1_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TTjj2": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_ttjj_2_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TTjj3": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_ttjj_3_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TTjj4": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_ttjj_4_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet0TTjj5": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT0Njet0_ttjj_5_hadd.root", nrun["TTJetsSemiLep"] * ( 1. - eff["TTJetsSemiLepNjet9"] ), xsec["TTJets"] * BR["TTJetsSemiLep"] * eff["TTJetsSemiLepNJet9"] ),
  "TTJetsSemiLepNjet9TT1b": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT500Njet9_tt1b_hadd.root", nrun["TTJetsSemiLep"] * eff["TTJetsSemiLepNjet9"] + nrun["TTJetsSemiLepNjet9"], xsec["TTJetsSemiLepNjet9"] ),
  "TTJetsSemiLepNjet9TT2b": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT500Njet9_tt2b_hadd.root", nrun["TTJetsSemiLep"] * eff["TTJetsSemiLepNjet9"] + nrun["TTJetsSemiLepNjet9"], xsec["TTJetsSemiLepNjet9"] ),
  "TTJetsSemiLepNjet9TTbb": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT500Njet9_ttbb_hadd.root", nrun["TTJetsSemiLep"] * eff["TTJetsSemiLepNjet9"] + nrun["TTJetsSemiLepNjet9"], xsec["TTJetsSemiLepNjet9"] ),
  "TTJetsSemiLepNjet9TTcc": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT500Njet9_ttcc_hadd.root", nrun["TTJetsSemiLep"] * eff["TTJetsSemiLepNjet9"] + nrun["TTJetsSemiLepNjet9"], xsec["TTJetsSemiLepNjet9"] ),
  "TTJetsSemiLepNjet9TTjj": ( "TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_HT500Njet9_ttjj_hadd.root", nrun["TTJetsSemiLep"] * eff["TTJetsSemiLepNjet9"] + nrun["TTJetsSemiLepNjet9"], xsec["TTJetsSemiLepNjet9"] ),
