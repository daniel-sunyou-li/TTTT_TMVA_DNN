...
inputDir = "/mnt/hadoop/store/group/bruxljm/FWLJMET102X_1lep2017_Oct2019_4t_12122019_step2/nominal/"
...
varList['BigComb'] = [
  ...
  ['topDRmax_HOTTaggerCalc'],
  ['topDThetaMax_HOTTaggerCalc'],
  ['topDiscriminator_HOTTaggerCalc'],
  ['topEta_HOTTaggerCalc'],
  ['topMass_HOTTaggerCalc'],
  ['topNconstituents_HOTTaggerCalc'],
  ['topPhi_HOTTaggerCalc'],
  ['topPt_HOTTaggerCalc'],
  ['topType_HOTTaggerCalc]
]
