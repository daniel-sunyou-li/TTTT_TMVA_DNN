...
step2DirLPC = { year: "~/nobackup/TTTT-singleLep/CMSSW_9_4_6_patch1/src/TTTT_TMVA_DNN/{}/".format( step2Sample[ year ] ) for year in step2Sample.keys() }

step3DirLPC = { year: "~/nobackup/TTTT-singleLep/CMSSW_9_4_6_patch1/src/TTTT_TMVA_DNN/{}/".format( step3Sample[ year ] ) for year in step2Sample.keys() }
